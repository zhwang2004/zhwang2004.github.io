---
title: "Ziheng Wang's Personal Homepage"
author_profile: true
---
...
- **Phone**: 136-4157-7335
- **GitHub**: [https://github.com/Nickory](https://github.com/Nickory)
- **Google Scholar**: [Ziheng Wang](https://scholar.google.com.hk/citations?hl=zh-CN&user=QrHma30AAAAJ)
...
- **Degree**: Bachelor's in Internet of Things Engineering (2022–2026)
- **GPA**: 3.969 / 4.0 (Rank: 2/34)

### Jingjiang High School
- **Graduation**: 2022, Jiangsu Province, China

---

## Research Interests

- **Early Diagnosis of Cardiovascular Diseases**: Development of adaptive algorithms and early warning systems.
- **UAV Intelligent Perception**: Multi-modal data fusion and 3D trajectory estimation for enhanced UAV target detection.
- **Pedestrian Re-Identification**: Visible light-infrared cross-modal recognition systems.
...
- **2024 China Undergraduate English Translation Contest**: 1st Place Provincial-level - First Prize.
- **2024 National Undergraduate Mathematical Modeling Contest**: 1st Place Provincial-level - Second Prize.
...
- **2023 "Three Good Student"**
- **2024 "Three Good Student"**
- **2024 Excellent Communist Youth League Cadre**

---

## Skills
- **Programming**: Python, Java, MATLAB, C++, LATEX.
- **Deep Learning**: Proficient in TensorFlow and PyTorch.
- **Data Analysis**: Expertise in data visualization using Origin and Adobe tools.
- **Database Management**: Proficient in MySQL and MongoDB.
- **Tools**: GitHub, AI tools (ChatGPT, Deepseek), and Linux.
